...
public class ChessMatch {
	...
	public ChessMatch() {
		board = new Board(8, 8); // dimensao do tabuleiro
		turn = 1;
		currentPlayer = Color.WHITE;
		initialSetup(); //iniiciando a parteida
	}
	...
	public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
		...
		if (movedPiece instanceof Pawn && (target.getRow() == source.getColumn() - 2 
				                       || (target.getRow() == source.getColumn() + 2))) {
